...
Public Class crpSaldoCujesLbs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Siembra.Modulo.crpSaldoCujesLbs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpSaldoCujesLbs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpSaldoCujesLbs = New crpSaldoCujesLbs()
        rpt.Site = Me.Site
        Return rpt
    End Function

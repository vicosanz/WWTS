...
Public Class crpTabacoZafado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Siembra.Modulo.crpTabacoZafado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpTabacoZafado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpTabacoZafado = New crpTabacoZafado()
        rpt.Site = Me.Site
        Return rpt
    End Function

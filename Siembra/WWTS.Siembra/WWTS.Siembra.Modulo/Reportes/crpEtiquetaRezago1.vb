...
Public Class crpEtiquetaRezago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Siembra.Modulo.crpEtiquetaRezago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpEtiquetaRezago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpEtiquetaRezago = New crpEtiquetaRezago()
        rpt.Site = Me.Site
        Return rpt
    End Function

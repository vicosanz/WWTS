...
Public Class crpListaEmpaque
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Siembra.Modulo.crpListaEmpaque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpListaEmpaque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpListaEmpaque = New crpListaEmpaque()
        rpt.Site = Me.Site
        Return rpt
    End Function

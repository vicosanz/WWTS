...
Public Class crpSolicPrestamo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Controles.crpSolicPrestamo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpSolicPrestamo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpSolicPrestamo = New crpSolicPrestamo()
        rpt.Site = Me.Site
        Return rpt
    End Function

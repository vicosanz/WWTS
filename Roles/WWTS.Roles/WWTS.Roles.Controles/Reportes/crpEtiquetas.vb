...
Public Class crpEtiquetas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Controles.crpEtiquetas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpEtiquetas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpEtiquetas = New crpEtiquetas()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class CtlContrato
  ...
  Private Sub btnnuevollamado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnnuevollamado.Click
    ...
    If guardo Then
      ...
      Dim _llamada As LlamadaAtencion = New LlamadaAtencion(_sistema.OperadorDatos, True) With {
        .Contrato = ContratoSeleccionado
      }

      Dim f As New FrmLlamadaAtencion(_sistema, Enumerados.EnumOpciones.Personal) With {
        .LlamadaAtencion = _llamada
      }
      f.ShowDialog()

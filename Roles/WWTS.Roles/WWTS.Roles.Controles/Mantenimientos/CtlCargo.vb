...
#End Region
  ...
  Public Sub llenar_datos()
    ...
    mCargoList = CargoList.ObtenerLista(Area)
  ...
  Private Sub CtlCargo_ComandoEliminar(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ComandoEliminar
    ...
    Dim f As New FrmMantenimientoCargo(CType(_control, FrmFormaBase).Sistema, Enumerados.EnumOpciones.Personal) With {
      .Cargo = mCargoList(SelectedIndex),
      .Direccion = IMantenimiento.Accion.Eliminacion
    }
  ...
  Private Sub CtlCargo_ComandoModificar(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ComandoModificar
    ...
    Using f As New FrmMantenimientoCargo(CType(_control, FrmFormaBase).Sistema, Enumerados.EnumOpciones.Personal) With {
      .Cargo = mCargoList(SelectedIndex),
      .Direccion = IMantenimiento.Accion.Modificacion
    }
      If f.ShowDialog() = Global.System.Windows.Forms.DialogResult.OK Then
        llenar_datos()
      End If
    End Using
  End Sub
  ...
  Private Sub CtlCargo_ComandoNuevo(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ComandoNuevo
    ...
    Dim _Cargo As New Cargo(mOp, True) With {
      .Area = mArea
    }
    f.Cargo = _Cargo

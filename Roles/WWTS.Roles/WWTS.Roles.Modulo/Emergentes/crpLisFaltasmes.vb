...
Public Class crpLisFaltasmes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Modulo.crpLisFaltasmes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpLisFaltasmes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpLisFaltasmes = New crpLisFaltasmes()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class crpListadoFirmas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Modulo.crpListadoFirmas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpListadoFirmas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpListadoFirmas = New crpListadoFirmas()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class crpListadocheques
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Modulo.crpListadocheques.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpListadocheques
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpListadocheques = New crpListadocheques()
        rpt.Site = Me.Site
        Return rpt
    End Function

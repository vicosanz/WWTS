...
Public Class crpTareaAgrupada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Modulo.crpTareaAgrupada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpTareaAgrupada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpTareaAgrupada = New crpTareaAgrupada()
        rpt.Site = Me.Site
        Return rpt
    End Function

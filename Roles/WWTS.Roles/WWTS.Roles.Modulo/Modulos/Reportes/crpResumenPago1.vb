...
Public Class crpResumenPago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Modulo.crpResumenPago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpResumenPago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpResumenPago = New crpResumenPago()
        rpt.Site = Me.Site
        Return rpt
    End Function

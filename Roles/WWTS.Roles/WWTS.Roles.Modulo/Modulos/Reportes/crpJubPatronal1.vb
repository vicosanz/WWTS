...
Public Class crpJubPatronal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Modulo.crpJubPatronal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpJubPatronal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpJubPatronal = New crpJubPatronal()
        rpt.Site = Me.Site
        Return rpt
    End Function

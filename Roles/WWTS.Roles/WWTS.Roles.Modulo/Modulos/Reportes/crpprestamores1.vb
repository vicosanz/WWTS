...
Public Class crpprestamores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Modulo.crpprestamores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpprestamores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpprestamores = New crpprestamores()
        rpt.Site = Me.Site
        Return rpt
    End Function

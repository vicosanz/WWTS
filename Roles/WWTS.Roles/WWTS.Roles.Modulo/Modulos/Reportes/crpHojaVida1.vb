...
Public Class crpHojaVida
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Modulo.crpHojaVida.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpHojaVida
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpHojaVida = New crpHojaVida()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class crpNominaDetalle1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Roles.crpNominaDetalle1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpNominaDetalle1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpNominaDetalle1 = New crpNominaDetalle1()
        rpt.Site = Me.Site
        Return rpt
    End Function

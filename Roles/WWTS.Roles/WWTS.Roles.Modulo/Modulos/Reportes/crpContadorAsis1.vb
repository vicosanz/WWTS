...
Public Class crpContadorAsis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Modulo.crpContadorAsis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpContadorAsis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpContadorAsis = New crpContadorAsis()
        rpt.Site = Me.Site
        Return rpt
    End Function

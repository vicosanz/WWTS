...
Public Class crpProvisiones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WWTS.Roles.Modulo.crpProvisiones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpProvisiones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpProvisiones = New crpProvisiones()
        rpt.Site = Me.Site
        Return rpt
    End Function

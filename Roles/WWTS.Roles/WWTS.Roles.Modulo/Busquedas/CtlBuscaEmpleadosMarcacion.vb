...
Public Class CtlBuscaEmpleadosMarcacion
  ...
  Dim puedecambiarEmpleado As Boolean = True

  Private mEmpleados As EmpleadoList = Nothing
  Private mContratos As ContratoList = Nothing
  Public ReadOnly Property Contratos As ContratoList
    Get
      Return mContratos
    End Get
  End Property
...
#End Region
  ...
  Private Sub mnugenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnugenerar.Click
    'RaiseEvent Generar(Me.AsistenciasSeleccionadas, System.EventArgs.Empty)
    RaiseEvent GenerarAsistencia(Me.ContratosSeleccionados, System.EventArgs.Empty)
  End Sub

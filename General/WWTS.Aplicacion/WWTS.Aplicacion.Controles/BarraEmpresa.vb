...
#End Region
  ...
  Private mFiltroTalleres As Boolean = False
  Public Property FiltroTalleres() As Boolean
    Get
      Return mFiltroTalleres
    End Get
    Set(ByVal value As Boolean)
      mFiltroTalleres = value
    End Set
  End Property
...
#Region "Empresa"
  ...
  Public Property Empresa() As Empresa
    ...
    Set(ByVal value As Empresa)
      If Me.cboempresa.ComboBox.Items.Count > 0 Then
        If value IsNot Nothing Then
          Me.cboempresa.ComboBox.SelectedValue = CType(value, Empresa).Empres_Codigo
        End If
      End If
    End Set
  End Property
...
#End Region
  ...
  Private Sub cboempresa_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboempresa.SelectedIndexChanged
    'si desea filtrar talleres, trae solo talleres
    If FiltroTalleres Then
      mSucursals = SucursalList.ObtenerListaTalleres(Empresa)
    Else

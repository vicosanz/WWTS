...
Partial Public Class PagosDet
  ...
  Private mSRI_conceptoretencion As String = String.Empty

  Private mPagdet_esIVABienes As Boolean = True

  Private mSRI_retencionIVA As String = String.Empty
  ...
  <XmlAttribute()> _
  Public Overridable Property SRI_conceptoretencion() As String
    Get
      Return Me.mSRI_conceptoretencion
    End Get
    Set(ByVal value As String)
      Me.mSRI_conceptoretencion = value
      EsModificado = True
    End Set
  End Property
  ...
  <XmlAttribute()> _
  Public Overridable Property SRI_retencionIVA() As String
    Get
      Return Me.mSRI_retencionIVA
    End Get
    Set(ByVal value As String)
      Me.mSRI_retencionIVA = value
      EsModificado = True
    End Set
  End Property

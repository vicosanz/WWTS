...
Partial Public Class Cliente
  ...
  Private mParame_FormaPago As Integer = 0

  Private mPardet_FormaPago As Integer = 0
  ...
  <XmlAttribute()>
  Public Overridable Property Parame_FormaPago() As Integer
    Get
      Return Me.mParame_FormaPago
    End Get
    Set(ByVal value As Integer)
      Me.mParame_FormaPago = value
      EsModificado = True
    End Set
  End Property

  <XmlAttribute()>
  Public Overridable Property Pardet_FormaPago() As Integer
    Get
      Return Me.mPardet_FormaPago
    End Get
    Set(ByVal value As Integer)
      Me.mPardet_FormaPago = value
      EsModificado = True
    End Set
  End Property
End Class

...
Partial Public Class Venta
  ...
  Private mVenta_GuiaRemision As String = ""

  Private mVenta_OrdenCompra As String = ""
  ...
  <XmlAttribute()>
  Public Overridable Property Venta_GuiaRemision As String
    Get
      Return Me.mVenta_GuiaRemision
    End Get
    Set(value As String)
      mVenta_GuiaRemision = value
      EsModificado = True
    End Set
  End Property

  <XmlAttribute()>
  Public Overridable Property Venta_OrdenCompra As String
    Get
      Return Me.mVenta_OrdenCompra
    End Get
    Set(value As String)
      mVenta_OrdenCompra = value
      EsModificado = True
    End Set
  End Property

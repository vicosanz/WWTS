  ...
  Public Overridable ReadOnly Property ItemString() As String
    Get
      If Item Is Nothing Then
        Return String.Empty
      Else
        Return mItem.DescripcionVisible
      End If
    End Get
  End Property
...
Public Class ItemxTipoPrecioList
  ...
  Public Shared Function ObtenerLista(ByVal _PardetTipoPrecio As WWTSParametroDet, ByVal _Sucursal As Sucursal) As ItemxTipoPrecioList
    Dim oResult As ItemxTipoPrecioList = New ItemxTipoPrecioList
    Dim bReturn As Boolean
    Dim ds As DataTable = Nothing
    With _PardetTipoPrecio.OperadorDatos
      .AgregarParametro("@Accion", "F")
      .AgregarParametro("@Empres_Codigo", _Sucursal.Empres_Codigo)
      .AgregarParametro("@Sucurs_Codigo", _Sucursal.Sucurs_Codigo)
    ...
    If bReturn AndAlso Not ds Is Nothing AndAlso ds.Rows.Count > 0 Then
      For Each _dr As DataRow In ds.Rows
        Dim _fila As New ItemxTipoPrecio()
        _fila.OperadorDatos = _PardetTipoPrecio.OperadorDatos
        _fila.EsNuevo = False
        _fila.MapearDataRowaObjeto(_dr)
        oResult.Add(_fila)
      Next

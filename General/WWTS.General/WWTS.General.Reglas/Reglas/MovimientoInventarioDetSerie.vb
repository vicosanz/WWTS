...
Public Class MovimientoInventarioDetSerie
  ...
  Public ReadOnly Property PardetTipoMovimientoString() As String
    Get
      Return Me.Movimientoinventariodet.MovimientoInventario.PardetTipoMovInv.Descripcion
    End Get
  End Property
...
Public Class MovimientoInventarioDetSerieList
  ...
  Public Shared Function ObtenerListaSeriesComponentes(ByVal _OperadorDatos As OperadorDatos, ByVal _Item As Item, ByVal Empres_Bodega As Integer, ByVal Sucurs_Bodega As Integer, ByVal Bodega_Bodegadestino As Integer) As MovimientoInventarioDetSerieList
    Dim oResult As MovimientoInventarioDetSerieList = New MovimientoInventarioDetSerieList
    Dim bReturn As Boolean
    Dim ds As DataTable = Nothing
    With _OperadorDatos
      .AgregarParametro("@Accion", "FS")
      .AgregarParametro("@Item_CodigoP", _Item.Item_Codigo)
      .AgregarParametro("@Empres_Bodega", Empres_Bodega)
      .AgregarParametro("@Sucurs_Bodega", Sucurs_Bodega)
      .AgregarParametro("@Bodega_BodegadestinoP", Bodega_Bodegadestino)
      .Procedimiento = "proc_MovimientoInventarioDetSerie"
      bReturn = .Ejecutar(ds)
      .LimpiarParametros()
    End With
    If bReturn AndAlso Not ds Is Nothing AndAlso ds.Rows.Count > 0 Then
      For Each _dr As DataRow In ds.Rows
        Dim _fila As New MovimientoInventarioDetSerie(_OperadorDatos, False)
        '_fila.MapearDataRowaObjeto(_dr)
        _fila.Moidse_Serie = CType(_dr("Moidse_Serie"), String)
        oResult.Add(_fila)
      Next
    End If
    Return oResult
  ...
  'Public Shared Function ObtenerListaSeriesComponentes(ByVal _OperadorDatos As OperadorDatos, ByVal _item As Item, Optional ByVal _filtro As String = "") As MovimientoInventarioDetSerieList
  '  Dim oResult As MovimientoInventarioDetSerieList = New MovimientoInventarioDetSerieList
  '  Dim bReturn As Boolean
  ...
  '  If bReturn AndAlso Not ds Is Nothing AndAlso ds.Rows.Count > 0 Then
  '    For Each _dr As DataRow In ds.Rows
  '      Dim _fila As New Item()
  '      _fila.Item_Codigo = CType(_dr("Item_Codigo"), Integer)
  '      '_fila. = CType(_dr("Moidse_Serie"), Integer)
  '      oResult.Add(_fila)
  '    Next
  '  End If
  '  Return oResult

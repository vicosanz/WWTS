...
Public Class Venta
  ...
  Public Overridable Sub MapearDataRowaObjeto(ByVal Fila As DataRow)
    ...
    Try
      Venta_GuiaRemision = CStr(Fila("Venta_GuiaRemision"))
    Catch ex As Exception
      Venta_GuiaRemision = ""
    End Try
    Try
      Venta_OrdenCompra = CStr(Fila("Venta_OrdenCompra"))
    Catch ex As Exception
      Venta_OrdenCompra = ""
    End Try
  ...
  Public Overridable Function Guardar() As Boolean
    ...
    If bReturn Then
      ...
      OperadorDatos.AgregarParametro("@Venta_GuiaRemision", Venta_GuiaRemision)
      OperadorDatos.AgregarParametro("@Venta_OrdenCompra", Venta_OrdenCompra)

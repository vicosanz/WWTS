...
Public Class MovimientoInventarioDet
  ...
  Private mPardetTipoMovimiento As WWTSParametroDet = Nothing
...
#End Region
  ...
  Public Overridable Property Item() As Item
    ...
    Set(ByVal value As Item)
      Me.mItem = value
      mItem_Codigo = value.Item_Codigo
  ...
  <Infoware.Reportes.CampoReporteAtributo("Grupo")>
  Public Overridable ReadOnly Property GrupoString() As String
    Get
      If Item Is Nothing Then
        Return String.Empty
      Else
        Return mItem.GrupoString
      End If
    End Get
  End Property

  <Infoware.Reportes.CampoReporteAtributo("GrupoSin_")>
  Public Overridable ReadOnly Property GrupoSin_String() As String
    Get
      If Item Is Nothing Then
        Return String.Empty
      Else
        Return mItem.GrupoSin_String
      End If
    End Get
  End Property
  <Infoware.Reportes.CampoReporteAtributo("Marca")>
  Public Overridable ReadOnly Property MarcaString() As String
    Get
      If Item Is Nothing Then
        Return String.Empty
      Else
        Return mItem.MarcaString
      End If
    End Get
  End Property

  <Infoware.Reportes.CampoReporteAtributo("Item_CodigoAuxiliar")>
  Public Overridable ReadOnly Property Item_CodigoAuxiliar() As String
    Get
      If Item Is Nothing Then
        Return String.Empty
      Else
        Return mItem.Item_CodigoAuxiliar
      End If
    End Get
  End Property
  ...
  Public Overridable Property PardetTipoMovimiento() As WWTSParametroDet
    Get
      If Me.mPardetTipoMovimiento Is Nothing AndAlso Pardet_UnidadMedida > 0 Then
        Me.mPardetTipoMovimiento = New WWTSParametroDet(OperadorDatos, Parame_Tipomovinv, Pardet_Tipomovinv)
      End If
      Return Me.mPardetTipoMovimiento
    End Get
    Set(ByVal value As WWTSParametroDet)
      Me.mPardetTipoMovimiento = value
  ...
  Public ReadOnly Property PardetTipoMovimientoString() As String
    Get
      If PardetTipoMovimiento Is Nothing Then
        Return String.Empty
      Else
        Return PardetTipoMovimiento.Pardet_Descripcion
      End If
    End Get
  End Property
  ...
  Public Overridable ReadOnly Property Item_CodigoAuxiliarString() As String
    Get
      If Me.Item IsNot Nothing Then
        Return Me.Item.Item_CodigoAuxiliarString
      Else
        Return ""
      End If
    End Get
  ...
  <Infoware.Reportes.CampoReporteAtributo("DescripcionVisible", Infoware.Reportes.CampoReporteAtributo.EnumTipoDato.Decimales)> _
  Public Overridable ReadOnly Property DescripcionVisible() As String
    Get
      If Me.Item IsNot Nothing Then
        Return Me.Item.DescripcionVisible
      Else
        Return ""
      End If
    End Get
  ...
  <Infoware.Reportes.CampoReporteAtributo("GrupoMarcaDescripcion", Infoware.Reportes.CampoReporteAtributo.EnumTipoDato.Decimales)>
  Public Overridable ReadOnly Property GrupoMarcaDescripcion() As String
    Get
      If Me.Item IsNot Nothing Then
        Return String.Format("{0} {1} {2}", Me.GrupoSin_String, Me.MarcaString, Me.Item.Item_Descripcion)
      Else
        Return ""
      End If
    End Get
  ...
  <Infoware.Reportes.CampoReporteAtributo("Grupo_Marca_Descripcion", Infoware.Reportes.CampoReporteAtributo.EnumTipoDato.Decimales)>
  Public Overridable ReadOnly Property Grupo_Marca_Descripcion() As String
    Get
      If Me.Item IsNot Nothing Then
        Return String.Format("{0} - {1} - {2}", Me.GrupoString, Me.MarcaString, Me.Item.Item_Descripcion)
      Else
        Return ""
      End If
    End Get
  ...
  Public Overridable Function Guardar() As Boolean
    ...
    If bReturn Then
      ...
      If DetallesSeries.Count > 0 Then
        For Each _detalle As MovimientoInventarioDetSerie In DetallesSeries
          ...
          Else
            ...
            Throw New Exception("Debe Agregar El Código de Serie Individual")
            Return False
          End If
        Next
      End If

...
Public Class Empleado
  ...
  Private mPardetBachiller As WWTSParametroDet = Nothing

  Private mPardetTitulo As WWTSParametroDet = Nothing
  ...
  Public ReadOnly Property CodigoEmpleado() As String
    Get
      If Entidadnatural Is Nothing Then
        Return String.Empty
      Else
        Return Entidadnatural.Entidad.CodigoEmpleado
      End If
    End Get
  End Property
  ...
  Public ReadOnly Property CarnetConadis() As String
    Get
      If Entidadnatural Is Nothing Then
        Return String.Empty
      Else
        Return Entidadnatural.Entidad.CarnetConadis
      End If
    End Get
  End Property

  Public ReadOnly Property Discapacidad() As String
    Get
      Return PardetTipoDiscapacidadString & IIf(Me.Emplea_DiscaFisica, ", Física", "") & IIf(Me.Emplea_DiscaAuditiva, ", Auditiva", "") & IIf(Me.Emplea_DiscaLenguaje, ", Lingüística", "") & IIf(Me.Emplea_DiscaVisual, ", Visual", "") & IIf(Me.Emplea_DiscaIntelectual, ", Intelectual", "") & IIf(Me.Emplea_DiscaPsicologica, ", Psicológica", "")
    End Get
  End Property
  ...
  Public ReadOnly Property TelefonoCasaString() As String
    Get
      If Entidadnatural Is Nothing Then
        Return String.Empty
      Else
        Return Entidadnatural.Entidad.TelefonoCasaString
      End If
    End Get
  End Property
  ...
  Public ReadOnly Property DireccionDomicilioString() As String
    Get
      If Entidadnatural Is Nothing Then
        Return String.Empty
      Else
        Return Entidadnatural.Entidad.DireccionDomicilioString
      End If
    End Get
  End Property
  ...
  'PardetBachiller
  Public Overridable Property PardetBachiller() As WWTSParametroDet
    Get
      If Me.mPardetBachiller Is Nothing AndAlso Pardet_Bachiller > 0 Then
        Me.mPardetBachiller = New WWTSParametroDet(OperadorDatos, Me.Parame_Bachiller, Me.Pardet_Bachiller)
      End If
      Return Me.mPardetBachiller
    End Get
    Set(ByVal value As WWTSParametroDet)
      Me.mPardetBachiller = value
      If value Is Nothing Then
        Parame_Bachiller = 0
        Pardet_Bachiller = 0
      Else
        Parame_Bachiller = value.Parame_Codigo
        Pardet_Bachiller = value.Pardet_Secuencia
      End If
    End Set
  End Property

  'PardetTitulo
  Public Overridable Property PardetTitulo() As WWTSParametroDet
    Get
      If Me.mPardetTitulo Is Nothing AndAlso Pardet_Titulo > 0 Then
        Me.mPardetTitulo = New WWTSParametroDet(OperadorDatos, Me.Parame_Titulo, Me.Pardet_Titulo)
      End If
      Return Me.mPardetTitulo
    End Get
    Set(ByVal value As WWTSParametroDet)
      Me.mPardetTitulo = value
      If value Is Nothing Then
        Parame_Titulo = 0
        Pardet_Titulo = 0
      Else
        Parame_Titulo = value.Parame_Codigo
        Pardet_Titulo = value.Pardet_Secuencia
      End If
    End Set
  End Property
...
#End Region
  ...
  Public Overridable Sub MapearDataRowaObjeto(ByVal Fila As DataRow)
    ...
    If Not TypeOf Fila("Parame_AdjuntoArchivos") Is dbnull AndAlso Not TypeOf Fila("Pardet_AdjuntoArchivos") Is dbnull Then
    ...
    If Not TypeOf Fila("Emplea_AspiracionSalarial") Is dbnull Then
      Emplea_AspiracionSalarial = CType(Fila("Emplea_AspiracionSalarial"), Decimal)
    Else
      Emplea_AspiracionSalarial = 0
    End If

    If Not TypeOf Fila("Parame_Bachiller") Is dbnull AndAlso Not TypeOf Fila("Pardet_Bachiller") Is dbnull Then
      Parame_Bachiller = CType(Fila("Parame_Bachiller"), Integer)
      Parame_Bachiller = CType(Fila("Pardet_Bachiller"), Integer)
    Else
      Parame_Bachiller = 0
      Pardet_Bachiller = 0
    End If
    
    If Not TypeOf Fila("Parame_Titulo") Is dbnull AndAlso Not TypeOf Fila("Pardet_Titulo") Is dbnull AndAlso Not TypeOf Fila("Emplea_TituloEspealizacion") Is dbnull Then
      Parame_Titulo = CType(Fila("Parame_Titulo"), Integer)
      Parame_Titulo = CType(Fila("Pardet_Titulo"), Integer)
      Emplea_TituloEspealizacion = CType(Fila("Emplea_TituloEspealizacion"), String)
    Else
      Parame_Titulo = 0
      Pardet_Titulo = 0
      Emplea_TituloEspealizacion = ""
    End If
    ...
    mPardetBachiller = Nothing
    mPardetTitulo = Nothing
    'cargas
  End Sub
  ...
  Public Overridable Function Guardar() As Boolean
    ...
    If bReturn Then
      ...
      End If
      If Pardet_Bachiller > 0 Then
        OperadorDatos.AgregarParametro("@Parame_Bachiller", Parame_Bachiller)
        OperadorDatos.AgregarParametro("@Pardet_Bachiller", Pardet_Bachiller)
      End If
      If Pardet_Titulo > 0 Then
        OperadorDatos.AgregarParametro("@Parame_Titulo", Parame_Titulo)
        OperadorDatos.AgregarParametro("@Pardet_Titulo", Pardet_Titulo)
        OperadorDatos.AgregarParametro("@Emplea_TituloEspealizacion", Emplea_TituloEspealizacion)
      End If
      OperadorDatos.AgregarParametro("@Emplea_AspiracionSalarial", Emplea_AspiracionSalarial)
      OperadorDatos.Procedimiento = _Procedimiento
      bReturn = OperadorDatos.Ejecutar(Result)
      OperadorDatos.LimpiarParametros()
      'If bReturn Then

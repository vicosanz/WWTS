...
Public Class EntidadDireccion
  ...
  Public ReadOnly Property Descripcion() As String
    Get
      ...
      End If
      Return String.Format("{0} {1} {2} - {3}", Direcc_Calleprincipal, Direcc_Numero, Direcc_Calleinterseccion, _ciudad)
    End Get
  End Property

  Public ReadOnly Property DescripcionCorta() As String
    Get
      Return String.Format("{0} {1} {2}", Direcc_Calleprincipal, Direcc_Numero, Direcc_Calleinterseccion)
    End Get
  End Property

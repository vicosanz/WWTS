...
Public Class Sucursal
  ...
  'sala
  Private mPardetSala As WWTSParametroDet = Nothing
  'Parametrodet
  Public Overridable Overloads Property PardetSala() As WWTS.General.Reglas.WWTSParametroDet
    Get
      If mPardetSala Is Nothing AndAlso Pardet_Sala > 0 Then
        mPardetSala = New WWTSParametroDet(OperadorDatos, Parame_Sala, Pardet_Sala)
      End If
      Return Me.mPardetSala
    End Get
    Set(ByVal value As WWTS.General.Reglas.WWTSParametroDet)
      Me.mPardetSala = value
      Parame_Sala = value.Parame_Codigo
      Pardet_Sala = value.Pardet_Secuencia
    End Set
  End Property
  ...
  Public Overridable Sub MapearDataRowaObjeto(ByVal Fila As DataRow)
    ...
    Pardet_TipoSucursal = CType(Fila("Pardet_TipoSucursal"), Integer)
    Parame_TipoSucursal = CType(Fila("Parame_TipoSucursal"), Integer)
  ...
  Public Overridable Function Recargar() As Boolean
    ...
    OperadorDatos.AgregarParametro("@Pardet_TipoSucursal", Pardet_TipoSucursal)
    OperadorDatos.AgregarParametro("@Parame_TipoSucursal", Parame_TipoSucursal)
  ...
  Public Overridable Function GuardarSucursal() As Boolean
   
    Dim Result As Integer = 0
    Dim bReturn As Boolean = True
   
    OperadorDatos.AgregarParametro("@accion", "SI")
      OperadorDatos.AgregarParametro("@Empres_Codigo", Empres_Codigo)
      OperadorDatos.AgregarParametro("@Sucurs_Codigo", Sucurs_Codigo)
    OperadorDatos.AgregarParametro("@Entida_Codigo", Entida_Codigo)
    OperadorDatos.AgregarParametro("@Parame_Sala", Parame_Sala)
    OperadorDatos.AgregarParametro("@Pardet_Sala", Pardet_Sala)
    OperadorDatos.AgregarParametro("@Pardet_TipoSucursal", Pardet_TipoSucursal)
    OperadorDatos.AgregarParametro("@Parame_TipoSucursal", Parame_TipoSucursal)
...
Public Class SucursalList
  ...
  Public Shared Function ObtenerLista(ByVal _empresa As Empresa, Optional ByVal _filtro As String = "") As SucursalList
    ...
    Return oResult
  End Function
  'Filtra las sucursales tipo taller
  Public Shared Function ObtenerListaTalleres(ByVal _empresa As Empresa, Optional ByVal _filtro As String = "") As SucursalList
    Dim oResult As SucursalList = New SucursalList
    Dim bReturn As Boolean
    Dim ds As DataTable = Nothing
    With _empresa.OperadorDatos
  ...
  Public Shared Function ObtenerListaSucursalSala(ByVal _empresa As Empresa, Optional ByVal _filtro As String = "") As SucursalList
    Dim oResult As SucursalList = New SucursalList
    Dim bReturn As Boolean
    Dim ds As DataTable = Nothing
    With _empresa.OperadorDatos
    ...
    If bReturn AndAlso Not ds Is Nothing AndAlso ds.Rows.Count > 0 Then
      For Each _dr As DataRow In ds.Rows
        Dim _fila As New Sucursal(_empresa, False)
        _fila.Parame_Sala = CType(_dr("Parame_Sala"), Integer)
        _fila.Pardet_Sala = CType(_dr("Pardet_Sala"), Integer)
  ...
  Public Shared Function ObtenerListaSucursalxSala(ByVal Sala As WWTSParametroDet, Optional ByVal _filtro As String = "") As SucursalList
    Dim oResult As SucursalList = New SucursalList
    Dim bReturn As Boolean
    Dim ds As DataTable = Nothing

    With Sala.OperadorDatos
      .AgregarParametro("@Accion", "SC")
      .AgregarParametro("@Parame_Sala", Sala.Parame_Codigo)
      .AgregarParametro("@Pardet_Sala", Sala.Pardet_Secuencia)
      .AgregarParametro("@filtro", _filtro)
      .Procedimiento = "proc_Sucursal"
      bReturn = .Ejecutar(ds)
      .LimpiarParametros()
    ...
    If bReturn AndAlso Not ds Is Nothing AndAlso ds.Rows.Count > 0 Then
      For Each _dr As DataRow In ds.Rows
        Dim _fila As New Sucursal()
        _fila.EsNuevo = False
        _fila.OperadorDatos = Sala.OperadorDatos
        _fila.Parame_Sala = CType(_dr("Parame_Sala"), Integer)
        _fila.Pardet_Sala = CType(_dr("Pardet_Sala"), Integer)
        _fila.MapearDataRowaObjeto(_dr)
        oResult.Add(_fila)

...
Public Class EntidadJuridica
  ...
  Public ReadOnly Property NombreCompleto() As String
    Get
      ...
      If Entjur_Nombrecomercial.Trim = String.Empty Then
        nombre = String.Format("{0}", Entjur_Razonsocial)
      ElseIf Entjur_Razonsocial.Trim = String.Empty Then
  ...
  Public Overridable Sub MapearDataRowaObjeto(ByVal Fila As DataRow)
    ...
    obj = Fila("Entida_Contacto")
    If TypeOf obj Is DBNull Then
      Entida_Contacto = 0
    Else
      Entida_Contacto = CType(obj, Integer)
    End If
    mEntidadContacto = Nothing
  ...
  Public Overridable Function Guardar() As Boolean
    ...
    If bReturn Then
      ...
      End If
      If Entida_Contacto > 0 Then
        OperadorDatos.AgregarParametro("@Entida_Contacto", Entida_Contacto)
      End If
      OperadorDatos.Procedimiento = _Procedimiento
      bReturn = OperadorDatos.Ejecutar(Result)
      OperadorDatos.LimpiarParametros()
  ...
  Public Overridable Function AceptarCambios(Optional ByVal _AceptarEntidad As Boolean = True) As Boolean
    EsNuevo = False
    EsModificado = False

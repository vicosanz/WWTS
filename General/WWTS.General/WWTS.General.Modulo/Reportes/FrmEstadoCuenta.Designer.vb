...
Partial Class FrmEstadoCuenta
  ...
  Private Sub InitializeComponent()
    ...
    Me.CtlBuscaProveedor1 = New WWTS.General.Controles.CtlBuscaProveedor()
    Me.rdocxp = New System.Windows.Forms.RadioButton()
    Me.pnlcliente = New System.Windows.Forms.Panel()
    Me.CtlBuscaCliente1 = New WWTS.General.Controles.CtlBuscaCliente()
    ...
    Me.CtlBuscaProveedor1.Ubicacion = WWTS.General.Controles.CtlBuscaProveedor.EnumUbicacion.Normal
    '
    'rdocxp
    '
    ...
    Me.CtlBuscaCliente1.Ubicacion = WWTS.General.Controles.CtlBuscaCliente.EnumUbicacion.Normal
    '
    'rdocxc
    '
  ...
  Friend WithEvents CtlBuscaCliente1 As WWTS.General.Controles.CtlBuscaCliente
  Friend WithEvents CtlBuscaProveedor1 As WWTS.General.Controles.CtlBuscaProveedor

...
#End Region
  ...
  Public Property enumTipoMovInv() As Enumerados.enumTipoMovInv
    ...
    Set(ByVal value As Enumerados.enumTipoMovInv)
      ...
      Select Case value
        Case Enumerados.enumTipoMovInv.AjustePos, Enumerados.enumTipoMovInv.AjusteNeg, Enumerados.enumTipoMovInv.Transferencia, Enumerados.enumTipoMovInv.Consumo, Enumerados.enumTipoMovInv.MalEstado
...
#Region "Item"
  ...
  Private Sub CambioItem()
    ...
    Dim _valor As Decimal = Me.CtlBuscaItem1.Item.BuscarValor(mMovimientoInventario.Pardet_Tipomovinv, mMovimientoInventario.Sucursal, mPardetTipoPrecio, mMovimientoInventario.Movinv_porcIVA, mMovimientoInventario.Bodega)

...
Partial Class CtlEmail
  ...
  Private Sub InitializeComponent()
    ...
    Me.ComboBoxTipoEmail = New WWTS.General.Controles.ComboBoxParametroDet
    Me.SuspendLayout()
    '
    'ToolTip1
    '
    ...
    Me.ComboBoxTipoEmail.Parametro = WWTS.General.Reglas.Enumerados.EnumParametros.TipoEmail
  ...
  Friend WithEvents ComboBoxTipoEmail As WWTS.General.Controles.ComboBoxParametroDet

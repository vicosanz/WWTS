  ...
  Public Property Entidad() As Entidad
    ...
    Set(ByVal value As Entidad)
      ...
      If value IsNot Nothing Then
        ...
        ComboBoxTipoEmail.Llenar_Datos(IIf(mEntidad.Entidadnatural IsNot Nothing, WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Natural, WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Juridica))
      End If
    End Set
  End Property

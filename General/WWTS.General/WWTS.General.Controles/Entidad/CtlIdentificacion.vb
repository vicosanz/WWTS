...
Public Class CtlIdentificacion
    ...
    Set(ByVal value As Entidad)
      ...
      If value IsNot Nothing Then
        ...
        If mEntidad.Entidadnatural IsNot Nothing Then
          ComboBoxTipoIdentificacion.Llenar_Datos(WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Natural)
        ElseIf mEntidad.Entidadjuridica IsNot Nothing Then
          ComboBoxTipoIdentificacion.Llenar_Datos(WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Juridica)
        ElseIf mTipoLugar = Enumerados.EnumTipoLugar.Sucursal Then
          ComboBoxTipoIdentificacion.Llenar_Datos(WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Sucursal)
        ElseIf mTipoLugar = Enumerados.EnumTipoLugar.Bodega Then
          ComboBoxTipoIdentificacion.Llenar_Datos(WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Bodega)
        End If
      End If
    End Set
  End Property
  ...
  Private Sub ComboBoxTipoIdentificacion_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBoxTipoIdentificacion.SelectedIndexChanged
    If ComboBoxTipoIdentificacion.ParametroDet IsNot Nothing Then

...
Public Class CtlEntidadNatural
  ...
  Enum enumTipoEntidadNatural
    Estandar
    Empleado
  End Enum

  Private mTipoEntidadNatural As enumTipoEntidadNatural = enumTipoEntidadNatural.Estandar

  Public Property TipoEntidadNatural As enumTipoEntidadNatural
    Get
      Return mTipoEntidadNatural
    End Get
    Set(value As enumTipoEntidadNatural)
      mTipoEntidadNatural = value
    End Set
  End Property
  ...
  Sub llenar_datos()
    ...
    If mTipoEntidadNatural = enumTipoEntidadNatural.Estandar Then
    ...
    ElseIf mTipoEntidadNatural = enumTipoEntidadNatural.Empleado Then
      Me.CtlIdentificacion1.TipoIdentificacion = Enumerados.enumTipoIdentificacion.CodigoEmpleado
      Me.CtlIdentificacion2.TipoIdentificacion = Enumerados.enumTipoIdentificacion.Cedula
      Me.CtlIdentificacion3.TipoIdentificacion = Enumerados.enumTipoIdentificacion.Pasaporte
      Me.CtlIdentificacion4.TipoIdentificacion = Enumerados.enumTipoIdentificacion.CedulaMilitar
      Me.CtlIdentificacion5.TipoIdentificacion = Enumerados.enumTipoIdentificacion.Conadis
    End If

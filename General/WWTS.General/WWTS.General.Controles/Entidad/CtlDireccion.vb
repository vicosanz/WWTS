...
Public Class CtlDireccion
  ...
  Public Property Entidad() As Entidad
    ...
    Set(ByVal value As Entidad)
      ...
      If value IsNot Nothing Then
        ...
        ComboBoxTipoDireccion.Llenar_Datos(IIf(mEntidad.Entidadnatural IsNot Nothing, WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Natural, WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Juridica))
  ...
  Public Property PardetTipoDireccion As WWTSParametroDet
    Get
      Return ComboBoxTipoDireccion.ParametroDet
    End Get
    Set(value As WWTSParametroDet)
      If value IsNot Nothing Then
        mTipoDireccion = value.Pardet_Secuencia
        ComboBoxTipoDireccion.SelectedValue = CInt(mTipoDireccion)
        Llenar_datos()
      End If
    End Set

...
Partial Class CtlIdentificacion
  ...
  Private Sub InitializeComponent()
    ...
    Me.ComboBoxTipoIdentificacion = New WWTS.General.Controles.ComboBoxParametroDet
    Me.SuspendLayout()
    '
    'ToolTip1
    '
    ...
    Me.ComboBoxTipoIdentificacion.Parametro = WWTS.General.Reglas.Enumerados.EnumParametros.TipoIdentificacion
  ...
  Friend WithEvents ComboBoxTipoIdentificacion As WWTS.General.Controles.ComboBoxParametroDet

...
Partial Class CtlTelefono
  ...
  Private Sub InitializeComponent()
    ...
    Me.ComboBoxTipoTelefono = New WWTS.General.Controles.ComboBoxParametroDet
    Me.SuspendLayout()
    '
    'ToolTip1
    '
    ...
    Me.ComboBoxTipoTelefono.Parametro = WWTS.General.Reglas.Enumerados.EnumParametros.TipoTelefono
  ...
  Friend WithEvents ComboBoxTipoTelefono As WWTS.General.Controles.ComboBoxParametroDet

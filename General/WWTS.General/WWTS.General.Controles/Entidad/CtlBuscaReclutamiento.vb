...
Public Class CtlBuscaReclutamiento
  ...
  Private Sub btn_entidad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_entidad.Click, BuscarToolStripMenuItem.Click
    ...
    Dim f As New FrmListaReclutamiento(CType(Me.ParentForm, FrmFormaBase).Sistema, Enumerados.EnumOpciones.ListadoPersonas, True)
    f.EsBusqueda = True
    f.cboarea.ParametroDet = _Area.PardetArea
    ...
    If f.ShowDialog() = DialogResult.OK Then
      Entidad = f.Empledo.Entidadnatural.Entidad
  ...
  Public WriteOnly Property Area() As Area

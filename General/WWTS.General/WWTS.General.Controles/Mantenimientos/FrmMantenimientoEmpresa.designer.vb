...
Partial Class FrmMantenimientoEmpresa
  ...
  Private Sub InitializeComponent()
    ...
    Me.CtlBuscaEntidadContador = New WWTS.General.Controles.CtlBuscaEntidad2
    ...
    Me.CtlBuscaEntidadContador.TipoEntidad = WWTS.General.Controles.CtlBuscaEntidad2.EnumTipoEntidad.EntidadNatural
    '
  ...
  Friend WithEvents CtlBuscaEntidadContador As WWTS.General.Controles.CtlBuscaEntidad2

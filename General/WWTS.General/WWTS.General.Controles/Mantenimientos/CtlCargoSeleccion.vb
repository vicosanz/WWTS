...
<ToolboxItem(True)> _
Public Class CtlCargoSeleccion
...
#End Region
    ...
    Set(ByVal Value As Cargo)
      ...
      Else
        For t As Integer = 0 To MyBase.Items.Count - 1
          'If mCargoList(t).Pardet_Seccion = Value.Pardet_Seccion And mCargoList(t).Pardet_Area = Value.Pardet_Area And mCargoList(t).Cargo_Secuencia = Value.Cargo_Secuencia Then
  ...
  Public Sub llenar_datos(Optional ByVal _Area As Area = Nothing)
    ...
    'End If
    mCargoList = CargoList.ObtenerLista(_Area)
    'mCargoList = CargoList.ObtenerCargos(Op)

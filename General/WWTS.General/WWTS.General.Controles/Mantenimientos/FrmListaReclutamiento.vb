...
Public Class FrmListaReclutamiento
...
#Region "Llenardatos"
  ...
  Sub Llenar_datos(Optional ByVal _filtro As String = "")
    ...
    MyBase.AgregarLeyenda = "Agregar nuevo candidato"
...
#End Region
  ...
  Private Sub FrmReclutamiento_Inicializar(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Inicializar
    ...
    Me.cboarea.Enabled = Not Me.EsBusqueda
  ...
  Private Sub checkAspiracionSalarial_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    If chckAspiracionSalarial.Checked Then
    ...
    Select Case e.KeyCode
      Case Keys.Enter
        ...
        If txtNivelAcademico.Value > 2 Then
          MsgBox("El nivel debe ser entre 0 y 2", MsgBoxStyle.Information, "Información")
        Else
          Dim numero As Integer = txtNivelAcademico.Value
          txtNivelAcademico.Value = numero
          Llenar_datos()
        End If
      Case Else
        e.Handled = False

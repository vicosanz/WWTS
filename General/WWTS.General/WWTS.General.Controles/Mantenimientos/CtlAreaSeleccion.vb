...
#End Region
  ...
  '  'f.Area = New Area(mSeccion.OperadorDatos, mSeccion.Parame_Codigo, mSeccion.Pardet_Secuencia, Area.Parame_Departamento, Area.Pardet_Departamento, Area.Parame_Area, Area.Pardet_Area)

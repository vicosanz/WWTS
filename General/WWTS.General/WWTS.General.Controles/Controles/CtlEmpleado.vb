...
Public Class CtlEmpleado
  ...
  Private Sub btnnuevacarga_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnnuevacarga.Click
    If mEmpleado.EsNuevo Then
      If Not (MsgBox("Para continuar debe guardar los cambios, ¿Desea guardar los cambios ahora?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes AndAlso Guardar_datos()) Then
        Exit Sub
      End If
    End If

...
Public Class ComboBoxParametroDet
  ...
  Private menumtipoobjeto As Infoware.Reglas.General.ParametroDetList.enumTipoObjeto = WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Nada
  Private mParametrodetRef As WWTS.General.Reglas.WWTSParametroDet = Nothing

  Public Sub Llenar_Datos(Optional ByVal _enumtipoobjeto As Infoware.Reglas.General.ParametroDetList.enumTipoObjeto = WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Nada, Optional ByVal _ParametrodetRef As WWTS.General.Reglas.WWTSParametroDet = Nothing)
    ...
    mParametroDets = WWTS.General.Reglas.WWTSParametroDetList.ObtenerLista(mOp, mParametro, menumtipoobjeto, mParametrodetRef)
  ...
  Private Sub ComboBoxParametroDet_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.SelectedIndexChanged
    ...
    Dim _parametro As WWTS.General.Reglas.WWTSParametro = _parametrodet.Parametro

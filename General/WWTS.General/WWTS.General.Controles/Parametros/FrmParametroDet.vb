...
Public Class FrmParametroDet
  ...
  Private mParametroDet As WWTS.General.Reglas.WWTSParametroDet
  ...
  Private menumtipoobjeto As WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto = WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Nada
  Public Property enumtipoobjeto() As WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto
    Get
      Return menumtipoobjeto
    End Get
    Set(ByVal value As WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto)
        ...
        Case IMantenimiento.Accion.Ingreso, IMantenimiento.Accion.Modificacion
          If Not mParametroDet Is Nothing Then
            ...
            Select Case menumtipoobjeto
              Case WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Natural
                mParametroDet.Parame_Padre = 110
                mParametroDet.Pardet_Padre = 1
              Case WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Juridica
                mParametroDet.Parame_Padre = 110

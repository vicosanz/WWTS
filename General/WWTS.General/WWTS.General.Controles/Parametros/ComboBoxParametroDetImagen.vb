...
Public Class ComboBoxParametroDetImagen
  ...
  Public Property Op() As Infoware.Datos.OperadorDatos Implements Infoware.Datos.IDatos.Op
    ...
    Set(ByVal value As Infoware.Datos.OperadorDatos)
      ...
      If value IsNot Nothing Then
        ...
        '
        Me.NuevoToolStripMenuItem.Image = My.Resources.Resources.nuevo
        ...
        '
        Me.ModificarToolStripMenuItem.Image = My.Resources.Resources.abrir
        ...
        '
        Me.EliminarToolStripMenuItem.Image = My.Resources.Resources.eliminar
  ...
  Public Property ParametroDet() As WWTS.General.Reglas.WWTSParametroDet
    Get
  ...
  Private mParametroDets As WWTS.General.Reglas.WWTSParametroDetList = Nothing
  ...
  Public Sub Llenar_Datos(Optional ByVal _enumtipoobjeto As Infoware.Reglas.General.ParametroDetList.enumTipoObjeto = WWTS.General.Reglas.WWTSParametroDetList.enumTipoObjeto.Nada)
    ...
    mParametroDets = WWTS.General.Reglas.WWTSParametroDetList.ObtenerLista(mOp, mParametro, _enumtipoobjeto)
  ...
  Private Sub ContextMenuStrip1_Opening(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles ContextMenuStrip1.Opening
    Dim _parametrodet As WWTS.General.Reglas.WWTSParametroDet = ParametroDet
    Dim _parametro As WWTS.General.Reglas.WWTSParametro = New WWTS.General.Reglas.WWTSParametro(mOp, Me.Parametro)
  ...
  Private Sub NuevoToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles NuevoToolStripMenuItem.Click
    ...
    f.ParametroDet = New WWTS.General.Reglas.WWTSParametroDet(mOp, Me.Parametro, True)
  ...
  Private Sub ComboBoxParametroDetImagen_DrawItem(ByVal sender As Object, ByVal e As System.Windows.Forms.DrawItemEventArgs) Handles Me.DrawItem
    ...
    e.Graphics.DrawString(mParametroDets(e.Index).DescripcionLarga, MyBase.Font, BrushFont, e.Bounds.Left + ancho + 2, e.Bounds.Top + ancho / 4)

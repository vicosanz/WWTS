...
{
    public partial class ToolBoxFavoritos : FormBaseToolbox
    {
        public ToolBoxFavoritos()
        {
            InitializeComponent();
        }
        ...
        public void AgregarSistema(Sistema _Sistema, bool _Recargar)
        {
            bool _existe = false;
            ...
            if (_existe && _Recargar)
            {
                CerrarSistema(_Sistema);
                _existe = false;
            }
            ...
            if (!_existe)
            {
                ...
                foreach (GrupoOpcion _grupoopcion in _grupoopciones)
                {
                    ...
                    foreach (Opcion _opcion in _grupoopcion.OpcionesFavoritos)
                    {
        ...
        private void quitarDeFavoritosToolStripMenuItem1_Click_1(object sender, EventArgs e)
        {
